...
| `$__unixEpochMilliFilter(dateColumn)`                      | Will be replaced by a time range filter using the specified column name with times represented as millisecond timestamps. For example, *dateColumn >= 1494410783152 AND dateColumn <= 1494497183142*         |
| `$__timeEpochMilli(dateColumn)`                            | Will be replaced by an expression to rename the column to `time` and converting the value to Unix timestamp. For example, *dateColumn / 1000.0 as "time"*                                                    |
| `$__unixEpochMilliFrom()`                                  | Will be replaced by the start of the currently active time selection as millisecond timestamp. For example, *1494410783152*                                                                                  |
| `$__unixEpochMilliTo()`                                    | Will be replaced by the end of the currently active time selection as millisecond timestamp. For example, *1494497183142*                                                                                    |
| `$__unixEpochMilliGroup(dateColumn,'5m', [fillmode])`      | Same as $__timeGroup, but for times stored as milliseconds timestamp                                                                                                                                         |
| `$__unixEpochMilliGroupAlias(dateColumn,'5m', [fillmode])` | Same as above, but also adds a column alias                                                                                                                                                                  |
| `$__timeEpochNano(dateColumn)`                             | Will be replaced by an expression to rename the column to `time` and converting the value to Unix timestamp. For example, *dateColumn / 1000000000.0 as "time"*                                              |
| `$__unixEpochNanoGroup(dateColumn,'5m', [fillmode])`       | Same as $__timeGroup, but for times stored as nanoseconds timestamp                                                                                                                                          |
| `$__unixEpochNanoGroupAlias(dateColumn,'5m', [fillmode])`  | Same as above, but also adds a column alias                                                                                                                                                                  |
